...
APlayerCameraManager* UFLookAtCamera::CachedCameraManager = nullptr;

void UFLookAtCamera::LookAtCamera(USceneComponent* TargetComponent, const bool bLockPitch, const bool bLockRoll)
{
